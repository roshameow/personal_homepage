...
tags:
  ...
  - alpha
  - simulation
last_modified_at: 2025-02-19T11:28
...
| Margin                                                                                                                                      | 建议 `margin > 4bps`                                                                              | `avg(PnL/total traded dollars)`                                                                                                                                        | 降低turnover                                                                                                                                                                                                                                                                              |
...
- 统计
	...
	- max (`ts_max_diff`)
- 调整分布
	- neutralize(`group_neutralize,ts_av_diff`): 让数据 mean=0
