var store = [{
        ...
        "excerpt":"stable-diffusion结构和controlnet插件 controlnet保持和stable-diffusion u-net上半部分相同的结构Resnetblock, SpatialTransfomer 结构和插件 lora可以应用在网络的任何线性结构上, 比如: attention里面的q,k,v,out层 feedforward里面的linear层 clip里面的mlp, fc层 这几种模型的作用的粒度不一样, 从小到大是: lora(线性层) &lt; Gligen=IpAdapter(SpatialTransformer层) &lt; Controlnet(U-net的block) 模型的size也是依次变大 reference [1] Hu, Edward J., Yelong Shen, Phillip Wallis, Zeyuan Allen-Zhu, Yuanzhi Li, Shean Wang, Lu Wang, and Weizhu Chen. “LoRA: Low-Rank Adaptation of Large Language Models.” arXiv, October 16, 2021....","categories": ["docs","deeplearning"],
        "tags": ["content","sdxl","attention"],
